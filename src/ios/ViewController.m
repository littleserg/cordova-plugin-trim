...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSString *cancelText = _cancelText;
    NSString *titleText = _titleText;
    NSString *confirmText = _confirmText;
    ...
    [self.trimmerView setRulerLabelInterval:1];
    ...
    self.navigationItem.leftBarButtonItem.title = cancelText;
    self.navigationItem.rightBarButtonItem.title = confirmText;
}
