...
- (void) trim:(CDVInvokedUrlCommand*)command {
    ...
    NSString *inputFilePath = [options objectForKey:@"path"];
    NSString *cancelText = [options objectForKey:@"cancelText"];
    NSString *titleText = [options objectForKey:@"titleText"];
    NSString *confirmText = [options objectForKey:@"confirmText"];
